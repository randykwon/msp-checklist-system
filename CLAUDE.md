...
MSP QnA Teams is an advanced dual Next.js application for AWS Managed Service Provider (MSP) partner program validation powered by Claude Code Agent Teams. It consists of:

1. **Main Application** (port 3010): User-facing checklist system with collaborative Agent Teams providing expert-level consultation
2. **Admin Application** (port 3011): Agent Teams management dashboard with performance monitoring and optimization

**Key Architecture Decision**: This system implements Claude Code Agent Teams with specialized agents working collaboratively. The admin system runs as a completely separate Next.js app on port 3011 for security and isolation.

**Agent Teams Architecture**: Four specialized agents collaborate to provide expert-level MSP validation:
- MSP Consultant Agent: AWS MSP expertise and compliance guidance
- Evidence Evaluator Agent: Multi-dimensional document assessment
- System Administrator Agent: Performance monitoring and optimization
- User Guide Agent: Personalized recommendations and guidance
