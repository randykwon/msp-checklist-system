#!/bin/bash
# ============================================================================
# Amazon Linux 2023 MSP Checklist 원클릭 자동 설치 스크립트
...
#   curl -fsSL https://raw.githubusercontent.com/randykwon/msp-checklist-system/main/ec2-userdata-install.sh | sudo bash
#
# 또는:
#   wget -qO- https://raw.githubusercontent.com/randykwon/msp-checklist-system/main/ec2-userdata-install.sh | sudo bash
#
# ============================================================================
...
dnf install -y curl git gcc gcc-c++ make python3 tar gzip --allowerasing
...
cat > /etc/nginx/conf.d/msp-checklist.conf << NGINXEOF
...
if command -v firewall-cmd > /dev/null 2>&1; then
    ...
    firewall-cmd --permanent --add-port=3010/tcp 2>/dev/null || true
    firewall-cmd --permanent --add-port=3011/tcp 2>/dev/null || true
