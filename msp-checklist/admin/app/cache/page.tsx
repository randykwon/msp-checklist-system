...
export default function CachePage() {
  ...
  const loadVersionStats = async (version: string) => {
    try {
      const response = await fetch(`/api/advice-cache?action=stats&version=${version}`);
      if (response.ok) {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 mb-2">조언 캐시 관리</h1>
              <p className="text-gray-600">
                평가 항목별 AI 조언과 가상 증빙 예제 캐시를 관리합니다
              </p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed rounded-md transition-colors duration-200"
                  >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <h3 className="text-sm font-medium text-gray-500">한국어 조언</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-1">
                    <h3 className="text-sm font-medium text-gray-500">영어 조언</h3>
                ...
                <div className="flex items-center justify-between bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <div className="flex items-center space-x-4">
                    ...
                    <select
                      ...
                      className="border-2 border-gray-400 rounded-lg px-4 py-2.5 text-sm text-gray-900 bg-white font-semibold focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors shadow-sm"
                    >
                  ...
                  {selectedVersion && (
                    <button
                      ...
                      className="inline-flex items-center px-5 py-3 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-lg text-sm font-bold hover:from-green-700 hover:to-teal-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {versions.map((version, index) => (
                        <tr key={version.version} className={index === 0 ? 'bg-blue-50' : ''}>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">캐시 시스템 가이드</h2>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
            ...
            <div className="relative top-4 mx-auto p-5 border w-full max-w-6xl shadow-lg rounded-md bg-white min-h-[90vh]">
              <div className="flex flex-col h-full">
                ...
                <div className="flex items-center justify-between mb-6 pb-4 border-b">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">캐시 내용 관리</h3>
                    <p className="text-sm text-gray-600 mt-1">
                  ...
                  <div className="flex items-center space-x-8">
                    <div>
                      ...
                      <select
                        ...
                        className="border-2 border-gray-400 rounded-lg px-4 py-3 text-sm text-gray-900 bg-white font-semibold focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors shadow-sm"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="border-2 border-gray-400 rounded-lg px-4 py-3 text-sm text-gray-900 bg-white w-64 font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors shadow-sm placeholder-gray-500"
                      />
                    </div>
                  </div>
                ...
                <div className="flex-1 overflow-y-auto">
                  <div className="space-y-4">
                    {filteredCacheItems.map((item) => (
                      <div key={item.id} className="bg-white rounded-lg p-6 border-2 border-gray-200 shadow-sm hover:shadow-lg hover:border-blue-300 transition-all duration-200">
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            <div className="flex items-center space-x-3 mb-2">
                              <span className="font-mono text-sm bg-blue-700 text-white px-4 py-2 rounded-lg font-bold shadow-sm">
                                {item.itemId}
                              </span>
                          ...
                          <button
                            ...
                            className="inline-flex items-center px-5 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg text-sm font-bold hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
                          >
                            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="space-y-5">
                          <div>
                            ...
                            <div className="bg-white p-5 rounded-lg border-2 border-blue-200 text-sm text-gray-900 whitespace-pre-wrap leading-relaxed shadow-sm">
                              {item.advice}
                            </div>
                          </div>
                          ...
                          {item.virtualEvidence && (
                            <div>
                              ...
                              <div className="bg-white p-5 rounded-lg border-2 border-green-200 text-sm text-gray-900 whitespace-pre-wrap leading-relaxed shadow-sm">
                                {item.virtualEvidence}
                              </div>
                            </div>
                          )}
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-60">
            <div className="relative top-4 mx-auto p-5 border w-full max-w-4xl shadow-lg rounded-md bg-white min-h-[90vh]">
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between mb-6 pb-4 border-b">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">조언 편집</h3>
                    <p className="text-sm text-gray-600 mt-1">
                ...
                <div className="flex-1 space-y-6">
                  <div>
                    ...
                    <textarea
                      ...
                      rows={12}
                      className="w-full border-2 border-gray-400 rounded-lg px-5 py-4 text-sm text-gray-900 bg-white font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors leading-relaxed shadow-sm"
                      placeholder="조언 내용을 입력하세요..."
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={8}
                      className="w-full border-2 border-gray-400 rounded-lg px-5 py-4 text-sm text-gray-900 bg-white font-medium focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors leading-relaxed shadow-sm"
                      placeholder="가상 증빙 예제를 입력하세요..."
                    />
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={`px-8 py-3 rounded-lg text-sm font-bold text-white transition-all duration-200 ${
                      isUpdating
                        ...
                        : 'bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-md hover:shadow-lg transform hover:scale-105'
                    }`}
                  >
                    {isUpdating ? (
                      <>
