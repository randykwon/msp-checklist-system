...
export default function CachePage() {
  ...
  const generateSummary = async () => {
    ...
    try {
      ...
      showMessage(`${LLM_PROVIDERS[llmConfig.provider].name} (${llmConfig.model})로 조언 요약을 생성 중입니다...`, 'info');
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  <button
                    ...
                    style={{
                      ...
                      cursor: isGeneratingSummary || !activeVersions.advice ? 'not-allowed' : 'pointer',
      ...
      {showSummaryModal && (
        ...
        >
          ...
          >
            {/* 헤더 */}
            <div style={{ 
              padding: '16px 20px', background: 'linear-gradient(135deg, #F59E0B 0%, #FBBF24 100%)', 
              color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'space-between' 
            }}>
              <div>
                <div style={{ fontSize: 18, fontWeight: 700 }}>📋 조언 캐시 요약</div>
                {summaryInfo && (
