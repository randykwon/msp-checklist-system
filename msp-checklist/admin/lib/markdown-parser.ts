...
export function parseMarkdownToHtml(markdown: string): string {
  ...
  html = html.replace(/^## (.+)$/gm, '<h3 style="font-size: 18px; font-weight: 700; color: #1f2937; margin: 24px 0 14px 0; padding-bottom: 10px; border-bottom: 2px solid #d1d5db;">$1</h3>');
  html = html.replace(/^# (.+)$/gm, '<h2 style="font-size: 20px; font-weight: 700; color: #111827; margin: 28px 0 16px 0; padding-bottom: 12px; border-bottom: 3px solid #9ca3af;">$1</h2>');
  
  // 굵은 글씨 (**text** 또는 __text__)
  html = html.replace(/\*\*([^*]+)\*\*/g, '<strong style="font-weight: 700; color: #1f2937;">$1</strong>');
  html = html.replace(/__([^_]+)__/g, '<strong style="font-weight: 700; color: #1f2937;">$1</strong>');
  
  // 이탤릭 (*text* 또는 _text_)
  html = html.replace(/\*([^*]+)\*/g, '<em style="font-style: italic;">$1</em>');
  html = html.replace(/_([^_]+)_/g, '<em style="font-style: italic;">$1</em>');
  
  // 이모지 헤더 스타일 (🔹, 📋, 💡 등으로 시작하는 굵은 텍스트)
  html = html.replace(/^((?:🔹|📋|💡|🎯|📊|✅|⚠️|📝|🔍|📁|🗂️|📄|🔧|⚙️|🚀|💾|📌|🎨|🌐|☁️|🔐|🛡️|📈|📉|🔗|📎|🏷️|🔔|💬|📢|🎉|✨|🌟|⭐|🔥|💪|👉|👆|👇|☑️|🔸|🔺|🔻|▶️|◀️|⏩|⏪|🔄|♻️|🔀|🔁|🔂|⏯️|⏸️|⏹️|⏺️|⏭️|⏮️|🎵|🎶|🔊|🔉|🔈|🔇|📻|🎙️|🎚️|🎛️|🎤|🎧|📱|💻|🖥️|🖨️|⌨️|🖱️|🖲️|💽|💾|💿|📀|🧮|🎥|🎬|📹|📼|🔍|🔎|🕯️|💡|🔦|🏮|📔|📕|📖|📗|📘|📙|📚|📓|📒|📃|📜|📄|📰|🗞️|📑|🔖|🏷️|💰|💴|💵|💶|💷|💸|💳|🧾|💹|✉️|📧|📨|📩|📤|📥|📦|📫|📪|📬|📭|📮|🗳️|✏️|✒️|🖋️|🖊️|🖌️|🖍️|📝|💼|📁|📂|🗂️|📅|📆|🗒️|🗓️|📇|📈|📉|📊|📋|📌|📍|📎|🖇️|📏|📐|✂️|🗃️|🗄️|🗑️|🔒|🔓|🔏|🔐|🔑|🗝️|🔨|🪓|⛏️|⚒️|🛠️|🗡️|⚔️|🔫|🪃|🏹|🛡️|🪚|🔧|🪛|🔩|⚙️|🗜️|⚖️|🦯|🔗|⛓️|🪝|🧰|🧲|🪜|⚗️|🧪|🧫|🧬|🔬|🔭|📡|💉|🩸|💊|🩹|🩺|🚪|🛗|🪞|🪟|🛏️|🛋️|🪑|🚽|🪠|🚿|🛁|🪤|🪒|🧴|🧷|🧹|🧺|🧻|🪣|🧼|🪥|🧽|🧯|🛒|🚬|⚰️|🪦|⚱️|🗿|🪧|🏧|🚮|🚰|♿|🚹|🚺|🚻|🚼|🚾|🛂|🛃|🛄|🛅|⚠️|🚸|⛔|🚫|🚳|🚭|🚯|🚱|🚷|📵|🔞|☢️|☣️|⬆️|↗️|➡️|↘️|⬇️|↙️|⬅️|↖️|↕️|↔️|↩️|↪️|⤴️|⤵️|🔃|🔄|🔙|🔚|🔛|🔜|🔝)[^\n]*<strong[^>]*>([^<]+)<\/strong>)/gm, 
    '<div style="font-size: 15px; font-weight: 700; color: #374151; margin: 16px 0 8px 0; display: flex; align-items: center; gap: 6px;">$1</div>');
  ...
  // 불릿 목록 (- 또는 *)
  html = html.replace(/^[-*]\s+(.+)$/gm, '<div style="display: flex; gap: 10px; margin: 6px 0 6px 12px; align-items: flex-start;"><span style="color: #6366f1; font-size: 8px; margin-top: 6px;">●</span><span style="flex: 1; line-height: 1.6;">$1</span></div>');
