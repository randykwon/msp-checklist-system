...
interface AssessmentViewProps {
  ...
  onItemFocus?: (item: {id: string; category: string; categoryKo?: string; title: string; titleKo?: string; met: boolean | null}) => void;
}
...
const AssessmentView = forwardRef<AssessmentViewRef, AssessmentViewProps>(({ items, assessmentType, onUpdate, onItemFocus }, ref) => {
