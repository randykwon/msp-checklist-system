...
export function parseMarkdownToHtml(markdown: string): string {
  ...
  // 불릿 목록 (- 또는 *)
  html = html.replace(/^[-*]\s+(.+)$/gm, '<div style="display: flex; gap: 10px; margin: 6px 0 6px 12px; align-items: flex-start;"><span style="color: #6366f1; font-size: 8px; margin-top: 6px;">●</span><span style="flex: 1; line-height: 1.6; color: inherit;">$2</span></div>');
